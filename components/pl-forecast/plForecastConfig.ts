...
export const ROWS_CORPORATE: ForecastRowDef[] = [
  ...
  { account: '급여(본부)', level: 1, isGroup: false, isCalculated: false, format: 'number' },
  { account: '복리후생비(본부)', level: 1, isGroup: false, isCalculated: false, format: 'number' },
  { account: '광고비', level: 1, isGroup: false, isCalculated: false, format: 'number' },
  { account: '외주비', level: 1, isGroup: false, isCalculated: false, format: 'number' },
